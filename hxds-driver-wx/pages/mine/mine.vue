<template>
	<view class="page">
		<view class="summary-container">
			...
			<view class="summary">
				<view class="row">
					...
					<image :src="realAuth ? '../../static/mine/icon-1.png' : '../../static/mine/icon-2.png'"
						mode="widthFix" class="auth-icon"></image>
		...
		<u-cell-group :border="false">
			...
			<u-cell-item icon="account-fill" :icon-style="icon" title="账号与安全" :border-top="false"
				@click="this.toPage('../../user/account/account')" />
			<u-cell-item icon="eye-fill" :icon-style="icon" title="接单热点地区"
				@click="this.toPage('../heat_chart/heat_chart')" />
			...
			<u-cell-item icon="file-text-fill" :icon-style="icon" title="用户指南" :border-bottom="false"
